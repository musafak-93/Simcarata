    ...
    <div class="container">
        <div class="row justify-content-lg-center">
            ...
            <div class="col-md-auto">
                <div class="p-5 mb-4  rounded-3">
                    <div class="mb-4  rounded-3">
                        <div class="container-fluid py-5">
                            <h5 class="display-6 fw-bold">Sekolah Tegalrejo</h5>
                        </div>
                                    ...
                                    <div class="col">
                                        <div class="card h-100" type="button" data-bs-toggle="collapse"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="card-title">Alamat : {{ $item->alamat }}</h5>
                                                <p class="card-text">Kepala Sekolah : {{ $item->kepalasekolah }}
                                                </p>
                ...
                <div class="card mt-6" style="width: 17rem;">
                    @foreach ($data_sekolah as $item)
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body">
                                <div class="card-body"
                                    ...
                                    <div>
                                        <h4 class="card-title">Kepala Sekolah : {{ $item->kepalasekolah }}</h4>
                                        <hr />
                                        <h6 class="card-title">Alamat : {{ $item->alamat }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
