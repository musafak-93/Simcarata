...
<head>
    ...
    <title>SIMCARATA - Pimpinan Pemuda Muhammadiyah</title>
                ...
                <div class="p-5 mb-4  rounded-3">
                    <div class="mb-4  rounded-3">
                        <div class="container-fluid py-5">
                            <h5 class="display-6 fw-bold" style="text-align: center">Pimpinan Pemuda Muhammadiyah Tegalrejo 2021-2025</h5>
                        </div>

                        <div class="row">
                            @foreach ($data_pm->where('organisasi', 'like', 'Pemuda Muhammadiyah')->where('masajabatan', 'like', '2021-2025') as $item)
