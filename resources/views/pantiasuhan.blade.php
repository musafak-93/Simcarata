...
<head>
    ...
    <title>SIMCARATA - Panti Asuhan</title>
                ...
                <div class="p-5 mb-4  rounded-3">
                    <div class="mb-4  rounded-3">
                        <div class="container-fluid py-5">
                            <h5 class="display-6 fw-bold">Panti Asuhan Tegalrejo</h5>
                        </div>

                        <div class="col-lg-8 col-md-10">
                            @foreach ($data_pantiasuhan as $item)
                                    ...
                                    <div class="col">
                                        <div class="card h-100" type="button" data-bs-toggle="collapse"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="card-text">Pengurus : {{ $item->pengurus }}</h5>
